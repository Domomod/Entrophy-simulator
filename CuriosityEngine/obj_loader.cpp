...
void IndexedModel::CalcTangents()
{
    for(unsigned int i = 0; i < indices.size(); i += 3)
    {
        ...
        float deltaU1= temptexCoords[i+1].x - temptexCoords[i].x;
        float deltaV1= temptexCoords[i+1].y - temptexCoords[i].y;
        float deltaU2= temptexCoords[i+2].x - temptexCoords[i].x;
        float deltaV2= temptexCoords[i+2].y - temptexCoords[i].y;
...
IndexedModel OBJModel::ToIndexedModel()
{
    ...
    for(unsigned int i = 0; i < numIndices; i++)
    {
        ...
        if(it == normalModelIndexMap.end())
        {
            ...
            normalModel.tangents.push_back(glm::vec3(0,0,0));
        }
        else
        ...
        normalModel.temptexCoords.push_back(uvs[currentIndex->uvIndex]);
        ...
        if(previousVertexLocation == (unsigned int)-1)
        {
            ...
            result.tangents.push_back(glm::vec3(0,0,0));
        }
        else
